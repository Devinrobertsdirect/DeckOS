...
const IntroRequest = z.object({
  ...
  botName: z.string().max(60).optional().default("Nobi"),
...
function fallbackBeats(name: string, providers: string[], hour: number, bot = "Nobi"): Beat[] {
...
router.post("/intro", async (req, res) => {
  ...
  const bot = (botName || "Nobi").trim() || "Nobi";

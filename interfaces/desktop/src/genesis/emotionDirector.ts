...
const LEXICON: Record<Exclude<Emotion, "neutral">, string[]> = {
  ...
  // (Rocky's signature words are in here too: "good good good", "amaze", "bad bad bad",
  //  "Question.", "Not understand." — his cadence drives his face.)
  happy: ["great", "love", "wonderful", "awesome", "glad", "happy", "delight", "perfect",
    ...
    "good good good", "yes yes yes", "cool cool cool", "is good"],
  ...
  sad: ["sorry", "unfortunately", "afraid", "sadly", "apolog", "regret", "too bad", "i can't",
    ...
    "bad bad bad", " sad.", "scared"],
  confused: ["confused", "not sure", "unsure", "i don't know", "i do not know", "unclear",
    "what do you mean", "no idea", "puzzl", "strange", "not understand", "i not know"],
  ...
  curious: ["interesting", "tell me more", "i wonder", "curious", "what if", "question."],

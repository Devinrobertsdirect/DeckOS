...
export const PROVIDERS: ProviderDef[] = [
  {
    ...
    blurb: "Deep reasoning, coding, long-form thinking — Nobi's APEX tier.",
  ...
  },
  {
    ...
    blurb: "One key, many models (Claude, GPT, Gemini, open models) — Nobi's default brain.",
  ...
  },
  {
    ...
    blurb: "A real, natural voice for Nobi — upgrades the default browser voice.",
